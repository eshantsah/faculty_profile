...
<img src="img/logo1.png"><h1 style="font-weight: bold;">Atharva College Of Engineering</h1>
<h5 style="font-weight: bold;font-size: 20px;-"><center> Charkop Naka, Malad - Marve Rd, Asmita Jyoti Housing Society,<br> Malad West, Mumbai, Maharashtra 400095 </center></h5><br>
<form action="logout.php" method="post">
         
          <button style="background-color: #00004c;color: #fff;height: 10%;width: 15%;font-size: 20px;" type="submit" name="submit" id="size">Logout</button>
          </form>
</div>
</div>
    <br><br>
