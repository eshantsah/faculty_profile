...
<h4>Result:</h4>
            <div class="form-group">           
              <input type="text" class="form-control" id="acheivement" placeholder="Format: Year-subject-class(FE)-percentage" name="result1">
            </div>

            <div class="form-group">           
              <input type="text" class="form-control" id="acheivement" placeholder="Format: Year-subject-class(FE)-percentage" name="result2">
            </div>

            <div class="form-group">           
              <input type="text" class="form-control" id="acheivement" placeholder="Format: Year-subject-class(FE)-percentage" name="result3">
            </div>


            <div class="form-group">           
              <input type="text" class="form-control" id="acheivement" placeholder="Format: Year-subject-class(FE)-percentage" name="result4">
            </div>
